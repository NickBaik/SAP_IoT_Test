...
while True:
    ...
    try:
        ...
        '''        
        data = json.dumps({"measureIds":[1,2,3,4,5,6], "values":[valueTemp,valueLight,valueUltrasonic,valueSound,valueRotary,valueActivity],"profileId":1700,"logNodeAddr":1})
        headers = {'content-type': 'application/json'}
        r = requests.post('https://aes-canary.hcp.iot.sap/iot/gateway/rest/measures/9F3CBE8344604EA79C9D127171F7B440',
